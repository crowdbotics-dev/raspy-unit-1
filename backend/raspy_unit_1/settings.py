"""
Django settings for raspy_unit_1 project.
...
ROOT_URLCONF = 'raspy_unit_1.urls'
...
WSGI_APPLICATION = 'raspy_unit_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Raspy Unit Support <support@raspy-unit-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "raspy_unit_1 API",
    "DESCRIPTION": "API documentation for raspy_unit_1 App",
    "VERSION": "v1",
}
